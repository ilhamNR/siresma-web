    ...
    <div class="container py-5 my-4">
        <div class="row gy-4">
            ...
            <div class="col-lg-3">
                ...
                <p class="text-3-5">
                    <strong class="d-block text-color-dark">Sistem Informasi Pengelolaan Sampah Kecamatan Semarang
                        Barat</strong>
        ...
        <div class="container py-2">
            <div class="row py-4">
                <div
                    ...
                    <p class="text-color-grey text-3-5">Sistem Informasi Pengelolaan Sampah Kecamatan Semarang Barat ©
