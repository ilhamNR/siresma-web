        ...
        <div class="row gy-4">
            <div class="col-lg-2 align-self-center mb-4 mb-lg-0 text-center">
                <a href="index.html" class="text-decoration-none">
                    <img src="img/Logo Siresma_2-01.svg" width="125" height="35" class="img-fluid"
                        alt="Footer Logo" />
                </a>
            ...
            <div class="col-lg-3">
                ...
                <p class="text-3-5">
                    <strong class="d-block text-color-dark">Sistem Resik Mandiri Kelurahan Sambiroto Kecamatan Tembalang</strong>
        ...
        <div class="container py-2">
            <div class="row py-4">
                <div
                    ...
                    <p class="text-color-grey text-3-5">Sistem Resik Mandiri Kelurahan Sambiroto Kecamatan Tembalang © 2023. All
                        Rights Reserved.</p>
                </div>
                <div
                    class="col-md-8 d-flex align-items-center justify-content-center justify-content-md-end mb-4 mb-lg-0">
                    <ul
                        class="footer-social-icons social-icons social-icons-clean social-icons-icon-light social-icons-big">
                        <li class="social-icons-instagram"><a href="https://www.instagram.com/siresma.official/" target="_blank"
                                title="Intagram"><i class="fab fa-instagram text-4"></i></a></li>
                        <li class="social-icons-twitter"><a href="http://www.twitter.com/" target="_blank"
                                title="Twitter"><i class="fab fa-twitter text-4"></i></a></li>
                        <li class="social-icons-facebook"><a href="http://www.facebook.com/" target="_blank"
                                title="Facebook"><i class="fab fa-facebook-f text-4"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
