                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item"
                                                                href="timbunan-sampah.html">Timbunan Sampah</a></li>
                                                        <li><a class="dropdown-item"
                                                                href="komposisi-sampah.html">Komposisi Sampah</a></li>
                                                        <li><a class="dropdown-item" href="sumber-sampah.html">Sumber
                                                                Sampah</a></li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="bank-sampah.html">Bank
                                                                Sampah</a></li>
                                                        <li><a class="dropdown-item" href="rumah-kompos.html">Rumah
                                                                Kompos</a></li>
