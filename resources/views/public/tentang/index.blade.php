            ...
            <div class="container position-relative z-index-1 mt-4 h-100">
                <div class="row h-100">
                    <div class="col align-self-end">
                        <div class="d-block">
                            <span
                                class="d-block custom-stroke-text-effect-1 custom-big-text-2 font-weight-bold opacity-2">TENTANG</span>
                        </div>
                        <div class="d-block">
                            <h1
        ...
        <div class="container text-center py-5 my-4">
            ...
            <div class="col text-center">
                <h3 class="text-color-dark  text-4 mb-4 appear-animation" data-appear-animation="fadeInUpShorterPlus"
                    data-appear-animation-delay="600">Dengan fokus utama pada pengelolaan bank sampah dan penyederhanaan
                    proses pilah sampah untuk masyarakat Kelurahan Sambiroto,
                    Tembalang, Kota Semarang, kami hadirkan solusi terintegrasi yang memikat untuk membantu Anda mengelola
                    sampah dan tabungan
            ...
            <div class="col text-center">
                <h3 class="text-color-dark  text-4 mb-4 appear-animation" data-appear-animation="fadeInUpShorterPlus"
                    ...
                    dilakukan oleh Kelurahan Sambiroto, Kecamatan Tembalang,Kota Semarang</h3>
            </div>
