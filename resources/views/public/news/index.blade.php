            ...
            <div class="container position-relative z-index-1 mt-4 h-100">
                <div class="row h-100">
                    <div class="col align-self-end">
                        <div class="d-block">
                            <span
                                class="d-block custom-stroke-text-effect-1 custom-big-text-2 font-weight-bold opacity-2">Berita</span>
                        </div>
                        <div class="d-block">
                            <h1
                ...
                <div class="col-md-4">
                    <div class="card h-100 d-flex flex-column">
                        <div class="card-body d-flex flex-column align-items-stretch">
                            ...
                            <p class="card-text text-justify">Tim PPK Ormawa BEM FIK UDINUS melakukan Pelatihan untuk
                                Memanfaatkan Minyak Jelantah dengan membuat Lilin Aromatherapy</p>
                ...
                <div class="col-md-4">
                    <div class="card h-100 d-flex flex-column">
                        <div class="card-body d-flex flex-column align-items-stretch">
                            ...
                            <p class="card-text text-justify">TIM PPK Ormawa BEM FIK UDINUS melakukan monitoring dan
                                evaluasi yang diadakan oleh Universitas Dian Nuswantoro yang bertempat di Gedung H lantai 1
                                Meeting Room UDINUS.</p>
                            <a href="#" class="btn btn-primary mt-auto">Read More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card h-100 d-flex flex-column">
                        <div class="card-body d-flex flex-column align-items-stretch">
                            ...
                            <p class="card-text text-justify">TIM PPK Ormawa BEM FIK UDINUS telah melakukan launching
                                aplikasi SIRESMA yang merupakan aplikasi untuk mendukung kegiatan PPK Ormawa BEM FIK di
                                Kelurahan Sambiroto pada tanggal 27 September 2023 kemarin</p>
                            <a href="#" class="btn btn-primary mt-auto">Read More</a>
                        </div>
                    </div>
                </div>
